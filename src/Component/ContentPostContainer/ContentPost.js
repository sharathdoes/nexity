      ...
      uploadTask.on(
        ...
        () => {
          ...
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            fetch(`http://localhost:3000/api/post/user/post`, {
              method: "POST",
              headers: {
      ...
      <div className='ContentUploadContainer'>
        ...
        <div style={{ marginLeft: '10px' }}>
          {imagePre !== null ? (
            <img
              src={imagePre}
              style={{ width: "410px", height: '250px', objectFit: "cover", borderRadius: '10px' }}
              alt=""
            />
          ) : VideoPre !== null ? (
            ...
            <div>
              <label htmlFor='file'>
                ...
                <input
                  ...
                  id="file"
                  style={{ display: "none" }}
                  onChange={(e) => [setFile(e.target.files[0]), setImagePre(URL.createObjectURL(e.target.files[0]))]}
                />
              </label>
              ...
              <label htmlFor='file2'>
                ...
                <input
                  ...
                  id="file2"
                  style={{ display: "none" }}
                  onChange={(e) => [setFile2(e.target.files[0]), setVideoPre(URL.createObjectURL(e.target.files[0]))]}
                />
              </label>
            </div>
            <button
