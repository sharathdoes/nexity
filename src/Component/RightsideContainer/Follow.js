...
export default function Follow({userdetails}) {
  ...
  // console.log(id);
    ...
    const handleFollow= async(e)=>{
            await fetch(`http://localhost:3000/api/user/following/${userdetails._id}` , {method:'PUT', headers:{'Content-Type':"application/JSON" , token:accessToken} , body:JSON.stringify({user:`${id}`})})
