...
export default function Resetpassword() {
  ...
  const handleClick = async(e)=>{
    e.preventDefault();
    await fetch(`http://localhost:3000/api/user/reset/password?${code}` , {method:"PUT" , headers:{'Content-Type':"application/JSON"} , body:JSON.stringify({password:password})}).then((data)=>{
